...
- **In-app theme picker** — nine built-in color schemes (goTidal, Catppuccin Mocha, Tokyo Night, Gruvbox, Nord, Rosé Pine, Dracula, Amber CRT, Golden Hour) plus an "Auto — match terminal" option, opened from Settings' Themes row as its own floating popup, with live preview as you move the cursor; the choice is persisted
